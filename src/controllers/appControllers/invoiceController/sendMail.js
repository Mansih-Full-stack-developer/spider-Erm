...
const sendViaApi = async ({ email, name, targetLocation }) => {
  try {
    ...
    const Spider_app_company_email = settings['Spider_app_company_email'];
    const company_name = settings['Spider'];
    ...
    const { data, error } = await resend.emails.send({
      from: 'Manish <manish.fsdeveloper@resend.dev>',
      to: "manish.fsdeveloper@gmail.com",
      subject: 'Invoice From ' + company_name,
      reply_to: Spider_app_company_email,
      attachments: [
        {
